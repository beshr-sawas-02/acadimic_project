...
//
//   // TextEditingControllers - final and initialized here (not late)
...
//
//     // تحديث Rx عند تغيير النصوص في الـ Controllers
...
//       DialogHelper.showErrorSnackbar(
//         title: 'Error',
//         message: 'Failed to get course: ${e.toString()}',
//       );
//     } finally {
//       isLoading.value = false;
//     }
...
//       DialogHelper.showErrorSnackbar(
//         title: 'Error',
//         message: 'Failed to get prerequisites: ${e.toString()}',
//       );
//       return [];
//     } finally {
//       isLoading.value = false;
...
//       DialogHelper.showErrorSnackbar(
//         title: 'Error',
//         message: 'Failed to get open courses: ${e.toString()}',
//       );
//     } finally {
//       isLoading.value = false;
//     }
...
//       DialogHelper.showErrorSnackbar(
//         title: 'Error',
//         message: 'Failed to open courses: ${e.toString()}',
//       );
//     } finally {
//       isLoading.value = false;
//     }
